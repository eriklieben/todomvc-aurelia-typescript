...
define('models/ChangeLog',["require", "exports", 'aurelia-framework', 'aurelia-event-aggregator'], function (require, exports, aurelia_framework_1, aurelia_event_aggregator_1) {
    "use strict";
    var ChangeLog = (function () {
        function ChangeLog(ea, todoItemFactory) {
            this.todoItemFactory = todoItemFactory;
        ...
        ChangeLog.prototype.handleEvent = function (event) {
...
define('resources/elements/lastModified',["require", "exports", 'aurelia-framework', 'aurelia-templating-resources', './../../models/ChangeLog'], function (require, exports, aurelia_framework_1, aurelia_templating_resources_1, ChangeLog_1) {
    "use strict";
    var LastModified = (function () {
        function LastModified(changeLog, signaler) {
            this.changeLog = changeLog;
            window.setInterval(function () {
                signaler.signal('refreshTimeAgo');
            }, 5000);
        }
        LastModified = __decorate([
            aurelia_framework_1.inject(ChangeLog_1.default, aurelia_templating_resources_1.BindingSignaler), 
            __metadata('design:paramtypes', [ChangeLog_1.default, aurelia_templating_resources_1.BindingSignaler])
        ], LastModified);
        return LastModified;
    }());
...
define('resources/value-converters/timeAgoValueConverter',["require", "exports", 'moment'], function (require, exports, moment) {
    "use strict";
    var TimeAgoValueConverter = (function () {
        function TimeAgoValueConverter() {
        }
        TimeAgoValueConverter.prototype.toView = function (value) {
            if (!value) {
                return 'never';
            }
    ...
    exports.TimeAgoValueConverter = TimeAgoValueConverter;
});
